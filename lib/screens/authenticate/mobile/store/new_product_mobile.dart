...
class NewProductMobile extends StatefulWidget {
  const NewProductMobile({super.key});

  @override
  _NewProductMobileState createState() => _NewProductMobileState();
}

class _NewProductMobileState extends State<NewProductMobile> {

...
import 'edit_product_mobile.dart';

class ProductMobile extends StatefulWidget {
  final Map<String, dynamic> producto;
  const ProductMobile({Key? key, required this.producto}) : super(key: key);

  @override
  State<ProductMobile> createState() => ProductMobileState();
}

class ProductMobileState extends State<ProductMobile> {
                            ...
                            onSelected: (value) {
                              if (value == 'edit') {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => EditProductMobile(producto: producto),
                                  ),
                                );
                              }
                            },

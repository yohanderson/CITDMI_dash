...
class OrderMobile extends StatefulWidget {
  ...
  const OrderMobile({super.key, required this.order});
        ...
        children: [
          ...
          ValueListenableBuilder<List<Map<String, dynamic>>>(
              ...
              builder: (context, value, child) {
                ...
                orderView = value.firstWhere((order) => order['orderid'] == widget.order['orderid']);

                state = orderView['state'].toString();

                Color containerColor;

                final timestamp = orderView['timestamp'];
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: Text('${orderView['nombre']} ${orderView['lastname']}',

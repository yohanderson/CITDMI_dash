...
class ReserveMobileView extends StatefulWidget {
  final Map<String, dynamic> reserve;

  const ReserveMobileView({
    Key? key,
    required this.reserve,
  }) : super(key: key);

  @override
  ReserveMobileViewState createState() => ReserveMobileViewState();
}

class ReserveMobileViewState extends State<ReserveMobileView> {

...
class SearchReservesTabletView extends StatefulWidget {

  const SearchReservesTabletView({Key? key,})
      : super(key: key);

  @override
  State<SearchReservesTabletView> createState() => SearchReservesTabletViewState();
}

class SearchReservesTabletViewState extends State<SearchReservesTabletView> {
                                  ...
                                  child: InkWell(
                                    onTap: () {
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => ReserveTabletView(
                                              reserve: reserve),
                                        ),
                                      );
                                    },

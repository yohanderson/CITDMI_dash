...
class DayReserveTabletView extends StatefulWidget {
  final DateTime selectedDay;
  const DayReserveTabletView(
      {Key? key,
      required this.selectedDay})
      : super(key: key);

  @override
  State<DayReserveTabletView> createState() => DayReserveTabletViewState();
}

class DayReserveTabletViewState extends State<DayReserveTabletView> {

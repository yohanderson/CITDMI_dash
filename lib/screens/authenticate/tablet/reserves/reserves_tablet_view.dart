import 'package:web_dash/screens/authenticate/tablet/reserves/reserve_tablet_view.dart';
...
import 'day_reserve_tablet_view.dart';


class ReservesTabletView extends StatefulWidget {

  const ReservesTabletView({Key? key,}) : super(key: key);

  @override
  State<ReservesTabletView> createState() => ReservesTabletViewState();
}

class ReservesTabletViewState extends State<ReservesTabletView> {
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const SearchReservesTabletView(),
                ),
              );
            },
          ),

...
class EditProductTablet extends StatefulWidget {
  final Map<String, dynamic> producto;

  const EditProductTablet({Key? key, required this.producto}) : super(key: key);

  @override
  EditProductTabletState createState() => EditProductTabletState();
}

class EditProductTabletState extends State<EditProductTablet> {

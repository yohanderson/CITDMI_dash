import 'package:web_dash/screens/authenticate/tablet/store/product_tablet.dart';
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';
import 'package:provider/provider.dart';
import '../../../../bloc/dates_state_bloc.dart';
import 'new_product_tablet.dart';
import 'orders/orders_tablet.dart';

class ShopTabletView extends StatefulWidget {
  const ShopTabletView({super.key});

  @override
  State<ShopTabletView> createState() => _ShopTabletViewState();
}

class _ShopTabletViewState extends State<ShopTabletView> {
            ...
            InkWell(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const NewProductTablet(),
                  ),
                );
              },
              child: Container(
            ...
            IconButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => OrdersNotifications(),
                    ),
                  );
                },

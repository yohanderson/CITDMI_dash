...
class  CircleChartMarginDesktop extends StatefulWidget {
  final ValueListenable<List<Map<String, dynamic>>> dates;
  const  CircleChartMarginDesktop({super.key, required this.dates});

  @override
  State<CircleChartMarginDesktop> createState() => CircleChartMarginDesktopState();
}

class CircleChartMarginDesktopState extends State<CircleChartMarginDesktop> {
  ...
  List<PieChartSectionData> showingSections() {
    ...
    if (total == 0) {
      ...
      final fontSize = isTouched ? 16.0 : 20.0;
